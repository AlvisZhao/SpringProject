...
<body>
	<!--头部-->
	<header>
		<div class="header_wrapper"style="background: darksalmon;">
			<img src="img/6.jpg" /> <font style="font-weight: bold;">Special家的小店管理</font>
	...
	<section>
		<!--左边主要菜单-->
		<div class="left_menu"style="background: darksalmon";>
			<ul class="ul_css">
				<li id="menu_index">欢迎老板视察</li>
				<li id="menu_univ">商品管理</li>
				<li id="menu_spider">网络爬虫</li>
				<li id="menu_prepare">地址准备</li>
				<li id="menu_generate">压力测试</li>
		...
		<div class="right_content">
			<div
				style="width: 100%; height: 35px; background: whitesmoke; line-height: 35px;">
				<font id="main_title" style="margin-left: 12px;">欢迎老板视察</font>
			</div>
					...
					<div class="first_first_div">
						...
						<div style="width: 100%; height: auto; position: relative;">
							...
							<div
								...
								<button
									style="width: 60px; height: 35px; background: darksalmon; margin-right: 20%;"
									onclick="close_add_win()">关闭</button>
								<button id="saveBtn"
									style="width: 60px; height: 35px; background: darksalmon;"
			...
			<div id="add_dialog_window"
				...
				<div
					...
					<div
						...
						<button style="margin-right: 40px; margin-left: 15px;background: darksalmon;"
...
<script type="text/javascript">
	...
	function dataAnalysis(){
		$.ajax({
			type : "GET",
			url : "http://localhost:8080/university/goods/dataAnalysis",
			dataType : "json",
			success : function(result) {
				console.log(JSON.stringify(result));
				if (result.status == 1) {
