...
//	}
	...
	public void start() {
		// TODO Auto-generated method stub
		System.out.println("===开始启动爬虫,看看同行~~~");
		// 爬取同行网页
		//String content = SpiderUtils.download("https://list.jd.com/list.html?tid=1000157");
		    //时尚饰品   https://channel.jd.com/shishangshipin.html
		    //耳饰 https://list.jd.com/list.html?cat=6144%2C6182%2C6191&go=0
		    //发饰 https://list.jd.com/list.html?cat=6144%2C6182%2C6192&go=0
		
		String content = SpiderUtils.download("https://list.jd.com/list.html?cat=6144%2C6182%2C6191&go=0");
		    // 匹配这个网页所有商品网址
