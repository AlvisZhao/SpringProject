...
public class MyDbUtils {
	...
	// 根据自己的数据库地址修改
	static DataSource ds = getDataSource("jdbc:mysql://192.168.159.139:3306/university?useUnicode=true&characterEncoding=UTF-8");
	...
	public static DataSource getDataSource(String connectURI) {
		...
		ds.setPassword("Dreamy@123456"); // MySQL的登陆密码
